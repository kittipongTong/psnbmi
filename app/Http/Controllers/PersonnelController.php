...
class PersonnelController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $Personnel->save();
    return redirect()->route('Personnel.index')->with('success','บันทึกข้อมูลเรียบร้อย');
  ...
  public function edit($id)
  {
    ...
    return view('Personnel.edit', compact('Personnel', 'id'));
  ...
  public function update(Request $request, $id)
  {
    ...
    return redirect()->route('Personnel.index')->with('success', 'อัพเดทข้อมูลเรียบร้อย');
  }
  ...
  public function destroy($id)
  {
      ...
      return redirect()->route('Personnel.index')->with('success', 'ลบข้อมูลเรียบร้อย');
  }

  // public function getProvinces()
  // {
  //     $provincess = DB::table('provinces')->pluck("provincesname","id");
  //
  ...
  //   {
  //           $states = DB::table("districts")->where("provinces_id",$id)->pluck("name","id");
