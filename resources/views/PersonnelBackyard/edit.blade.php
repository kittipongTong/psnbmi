...
<div class="container">
  ...
  <!-- แจ้งเตือน -->
    ...
    <form name="bmiForm" method="post" action="{{action('PersonnelBackyardController@update', $id)}}">
    {{csrf_field()}}
            ...
            <div > <a href="{{route('PersonnelBackyard.index')}}" class="btn btn-outline-info col-md-3">กลับหน้าแสดงข้อมูล</a> </div>
          </div>
